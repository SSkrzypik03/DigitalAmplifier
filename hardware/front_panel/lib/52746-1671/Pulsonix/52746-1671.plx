...
//256304/1447319/2.50/18/4/Connector
...
(library Library_1
	...
	(patternDef "527461671" (originalName "527461671")
		(multiLayer
			(pad (padNum 1) (padStyleRef r80_30) (pt -3.750, 3.250) (rotation 0))
			(pad (padNum 2) (padStyleRef r80_30) (pt -3.250, 3.250) (rotation 0))
			(pad (padNum 3) (padStyleRef r80_30) (pt -2.750, 3.250) (rotation 0))
			(pad (padNum 4) (padStyleRef r80_30) (pt -2.250, 3.250) (rotation 0))
			(pad (padNum 5) (padStyleRef r80_30) (pt -1.750, 3.250) (rotation 0))
			(pad (padNum 6) (padStyleRef r80_30) (pt -1.250, 3.250) (rotation 0))
			(pad (padNum 7) (padStyleRef r80_30) (pt -0.750, 3.250) (rotation 0))
			(pad (padNum 8) (padStyleRef r80_30) (pt -0.250, 3.250) (rotation 0))
			(pad (padNum 9) (padStyleRef r80_30) (pt 0.250, 3.250) (rotation 0))
			(pad (padNum 10) (padStyleRef r80_30) (pt 0.750, 3.250) (rotation 0))
			(pad (padNum 11) (padStyleRef r80_30) (pt 1.250, 3.250) (rotation 0))
			(pad (padNum 12) (padStyleRef r80_30) (pt 1.750, 3.250) (rotation 0))
			(pad (padNum 13) (padStyleRef r80_30) (pt 2.250, 3.250) (rotation 0))
			(pad (padNum 14) (padStyleRef r80_30) (pt 2.750, 3.250) (rotation 0))
			(pad (padNum 15) (padStyleRef r80_30) (pt 3.250, 3.250) (rotation 0))
			(pad (padNum 16) (padStyleRef r80_30) (pt 3.750, 3.250) (rotation 0))
			(pad (padNum 17) (padStyleRef r305_240) (pt -6.200, 1.325) (rotation 0))
			(pad (padNum 18) (padStyleRef r305_240) (pt 6.200, 1.325) (rotation 0))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.575) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.05 2.65) (pt 7.05 2.65) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.05 2.65) (pt 7.05 -3.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.05 -3.25) (pt -7.05 -3.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.05 -3.25) (pt -7.05 2.65) (width 0.025))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -8.4 5.4) (pt 8.4 5.4) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 8.4 5.4) (pt 8.4 -4.25) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 8.4 -4.25) (pt -8.4 -4.25) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -8.4 -4.25) (pt -8.4 5.4) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -7.05 -1) (pt -7.05 -3.25) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -7.05 -3.25) (pt 7 -3.25) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 7 -3.25) (pt 7.05 -3.25) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 7.05 -3.25) (pt 7.05 -1.5) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 7.05 -1.5) (pt 7.05 -1) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -3.6 4.2) (pt -3.6 4.2) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -3.6, 4.3) (radius 0.1) (startAngle 270) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -3.6 4.4) (pt -3.6 4.4) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -3.6, 4.3) (radius 0.1) (startAngle 90.0) (sweepAngle 180.0) (width 0.2))
		)
	)
	(symbolDef "52746-1671" (originalName "52746-1671")
	...
	(compDef "52746-1671" (originalName "52746-1671") (compHeader (numPins 18) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "52746-1671"))
		(attachedPattern (patternNum 1) (patternName "527461671")
			(numPads 18)
			(padPinMap
		...
		(attr "Mouser Part Number" "538-52746-1671")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Molex/52746-1671?qs=nDwhpid8gJYEmQ9M1KrTnw%3D%3D")
		(attr "Manufacturer_Name" "Molex")
		(attr "Manufacturer_Part_Number" "52746-1671")
		(attr "Description" "Easy-On FFC/FPC Connector, 0.50mm Pitch, Slider Series, Right-Angle, Bottom Contact, 2.00mm Height,  Circuits, Gold Plating")
		(attr "<Hyperlink>" "https://www.molex.com/pdm_docs/sd/527460671_sd.pdf")
		(attr "<Component Height>" "2.2")
		(attr "<STEP Filename>" "52746-1671.stp")
		(attr "<STEP Offsets>" "X=0;Y=2.75;Z=0.02")
