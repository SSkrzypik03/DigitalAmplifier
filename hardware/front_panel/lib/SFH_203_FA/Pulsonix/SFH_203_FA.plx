...
(library Library_1
	...
	(patternDef "SFH203FA" (originalName "SFH203FA")
		...
		(layerContents (layerNumRef 28)
			(line (pt 1.27 2.925) (pt 1.27 2.925) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.925) (startAngle 90.0) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.27 -2.925) (pt 1.27 -2.925) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.925) (startAngle 270) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "SFH_203_FA" (originalName "SFH_203_FA") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/DKDS41/DSANUWW0036828.pdf")
		(attr "<Component Height>" "8.9")
		(attr "<STEP Filename>" "SFH_203_FA.stp")
		(attr "<STEP Offsets>" "X=1.27;Y=0;Z=4")
