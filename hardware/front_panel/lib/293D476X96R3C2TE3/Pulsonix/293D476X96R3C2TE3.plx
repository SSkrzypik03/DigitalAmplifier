...
//183318/1447319/2.50/2/2/Capacitor Polarised
...
(library Library_1
	...
	(symbolDef "293D476X96R3C2TE3" (originalName "293D476X96R3C2TE3")
	...
	(compDef "293D476X96R3C2TE3" (originalName "293D476X96R3C2TE3") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "293D476X96R3C2TE3"))
		...
		(attr "Manufacturer_Part_Number" "293D476X96R3C2TE3")
		...
		(attr "<STEP Filename>" "293D476X96R3C2TE3.stp")
