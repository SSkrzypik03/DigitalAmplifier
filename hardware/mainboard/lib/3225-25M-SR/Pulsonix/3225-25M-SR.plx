...
//19267024/1447319/2.50/4/3/Crystal or Oscillator
...
(library Library_1
	...
	(patternDef "322525MSR" (originalName "322525MSR")
		(multiLayer
		...
		(layerContents (layerNumRef 18)
			(line (pt -2.3 -0.9) (pt -2.3 -0.9) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -2.25, -0.9) (radius 0.05) (startAngle 180.0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.2 -0.9) (pt -2.2 -0.9) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -2.25, -0.9) (radius 0.05) (startAngle .0) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "3225-25M-SR" (originalName "3225-25M-SR")
	...
	(compDef "3225-25M-SR" (originalName "3225-25M-SR") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "3225-25M-SR"))
		(attachedPattern (patternNum 1) (patternName "322525MSR")
			(numPads 4)
			(padPinMap
		...
		(attr "Manufacturer_Name" "SRPASSIVES")
		(attr "Manufacturer_Part_Number" "3225-25M-SR")
		(attr "Description" "Resonator: quartz; 25MHz; +/-10ppm; 9pF; SMD; 3.2x2.5x0.7mm")
		(attr "<Hyperlink>" "https://www.tme.eu/Document/9cb2d0edad968d8543e7bc99995fd180/3235.pdf")
		(attr "<Component Height>" "0.7")
		(attr "<STEP Filename>" "3225-25M-SR.stp")
