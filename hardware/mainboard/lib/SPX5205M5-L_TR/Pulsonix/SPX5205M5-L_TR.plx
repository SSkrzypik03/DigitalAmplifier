...
//8689949/1447319/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SPX5205M5-L_TR" (originalName "SPX5205M5-L_TR")
	...
	(compDef "SPX5205M5-L_TR" (originalName "SPX5205M5-L_TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SPX5205M5-L_TR"))
		...
		(attr "Mouser Part Number" "701-SPX5205M5-L/TR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/MaxLinear/SPX5205M5-L-TR?qs=S%2FCBhQS5rCqlkl0UDVhMhQ%3D%3D")
		(attr "Manufacturer_Name" "MaxLinear, Inc.")
		(attr "Manufacturer_Part_Number" "SPX5205M5-L/TR")
		(attr "Description" "LDO Voltage Regulators 150mA LOW NOISE LDO")
		(attr "<Hyperlink>" "https://www.mouser.fr/datasheet/2/146/SPX5205-1889004.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "SPX5205M5-L_TR.stp")
