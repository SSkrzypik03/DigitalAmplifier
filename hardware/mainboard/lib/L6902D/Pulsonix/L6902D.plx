...
//179414/1447319/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "L6902D" (originalName "L6902D")
	...
	(compDef "L6902D" (originalName "L6902D") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "VREF") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "FB") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "L6902D"))
		...
		(attr "Manufacturer_Part_Number" "L6902D")
		(attr "Description" "L6902D, Switching Regulator, Buck Controller, 1A, Adjustable, 1.235  34 V, 275 kHz, 8-Pin SO")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/l6902.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "L6902D.stp")
