...
//629482/1447319/2.50/2/2/Connector
...
(library Library_1
	...
	(compDef "726386-2" (originalName "726386-2") (compHeader (numPins 2) (numParts 1) (refDesPrefix J)
		...
		(attr "<STEP Offsets>" "X=0;Y=0;Z=10.04")
