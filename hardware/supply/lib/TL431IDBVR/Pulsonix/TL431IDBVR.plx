...
//344783/1447319/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TL431IDBVR" (originalName "TL431IDBVR")
	...
	(compDef "TL431IDBVR" (originalName "TL431IDBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "ANODE") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TL431IDBVR"))
		...
		(attr "Mouser Part Number" "595-TL431IDBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TL431IDBVR?qs=tJ5HNKWh3OWJ%2FSshA3ZRGQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TL431IDBVR")
		(attr "Description" "2% Accuracy Adjustable Precision Shunt Regulator")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tl431")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TL431IDBVR.stp")
