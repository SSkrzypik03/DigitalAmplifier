...
//353584/1447319/2.50/6/2/Connector
...
(library Library_1
	...
	(symbolDef "43045-0601" (originalName "43045-0601")
	...
	(compDef "43045-0601" (originalName "43045-0601") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "43045-0601"))
		...
		(attr "Manufacturer_Part_Number" "43045-0601")
		...
		(attr "<STEP Filename>" "43045-0601.stp")
		(attr "<STEP Offsets>" "X=-3.02;Y=-3.92;Z=3.86")
