...
//21050802/1447319/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "UCC287508DBVR" (originalName "UCC287508DBVR")
	...
	(compDef "UCC287508DBVR" (originalName "UCC287508DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "FLT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "DRV") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VDD") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "CS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "UCC287508DBVR"))
		...
		(attr "Manufacturer_Part_Number" "UCC287508DBVR")
		(attr "Description" "Converter Offline Flyback, Secondary Side SR Topology 100kHz SOT-23-6")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/ucc28750.pdf?ts=1759323086966&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FUCC28750")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "UCC287508DBVR.stp")
