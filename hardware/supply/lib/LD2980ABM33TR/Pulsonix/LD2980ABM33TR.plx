...
//179606/1447319/2.50/5/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LD2980ABM33TR" (originalName "LD2980ABM33TR")
	...
	(compDef "LD2980ABM33TR" (originalName "LD2980ABM33TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LD2980ABM33TR"))
		...
		(attr "Manufacturer_Part_Number" "LD2980ABM33TR")
		(attr "Description" "LDO Regulator 3.3V 0.05A SOT23-5 LD2980ABM33TR, Low Dropout Voltage Regulator, 0.05A, 3.3 V +/-0.5%, -3  16 Vin, 5-Pin SOT-23")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/ld2980.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "LD2980ABM33TR.stp")
